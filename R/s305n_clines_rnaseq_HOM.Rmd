---
title: "S305N Cell Lines RNAseq HOM Analysis"
author:
...
meta[[3]] <- data.frame(
  ...
  genotype = factor(sub(".*_(NWBB7|HCB8)_[68]W$", "\\1", cols)),
  dataset = rep("Bowles NCRAD", times = length(cols)),
  group = ifelse(sub(".*_(NWBB7|HCB8)_[68]W$", "\\1", cols) == "NWBB7", yes = "WT", no = "S305N")
)
